 ...
 <![endif]-->
	...
	<body>
		...
		<div class="wrapper" role="main">
			<div class="container">
				<h3 class="page-header">Controle Patrimonial</h3>
		        
				<form action="add.html">
					<div class="row">
					<div class="form-group col-md-2">
						<label for="codigo">Cód. Fornecedor</label>
					...
					<div class="form-group col-md-2">
						<label for="exampleInputEmail1">Data Aquisição</label>
					...
					<div class="row">
					<div class="form-group col-md-2">
						<label for="exampleInputEmail1">Cód. Congregação</label>
						<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor">
					</div>
					<div class="form-group col-md-6">
						<label for="nome">Nome</label>
					...
					<div class="form-group col-md-2">
					<label for="nome">Nº do Bem</label>
						<input type="text" class="form-control" id="nome" placeholder="Digite o valor">	
					</div>
					<div class="form-group col-md-2">
					...
					<div class="form-group col-lg-3 col-md-3">
						<label for="sel1">Tipo de Aquisição</label>
					...
					<div class="form-group col-md-6">
						<label for="exampleInputEmail1">Descrição Conta</label>
						<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor">
					</div>
					<div class="form-group col-md-2">
					...
					<div class="form-group col-md-2">
						<label for="exampleInputEmail1">Valor da Baixa</label>
						<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor">
					</div>
					</div>
					<!-- /.row -->
					...
					<div class="form-group col-md-6">
						<label for="exampleInputEmail1">Chave NFe</label>
						<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor">
					</div>
					<div class="form-group col-md-2">
						<label for="exampleInputEmail1">Venc. Garantia</label>
						<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor">
					</div>
					<div class="form-group col-md-2">
						<label for="exampleInputEmail1">Data Baixa</label>
						<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor">
					</div>
					</div>
					<!-- /.row -->
